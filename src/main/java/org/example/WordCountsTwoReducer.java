...
public class WordCountsTwoReducer extends Reducer<Text, Text, Text, Text> {

    public WordCountsTwoReducer() {
    }
    ...
    protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        ...
        for (Text val : values) {
            ...
            // How many words in a document (we add all words continuously to global variable)
